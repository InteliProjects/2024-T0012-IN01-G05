...
export default class TiledMapFase03 {
    constructor(scene) {
        // Recebe a cena como parâmetro
        this.scene = scene;
        // Cria o mapa de tiles
        this.map = this.scene.make.tilemap({ key: 'mapFase03' });
        ...
        this.platformsLayer = this.map.createLayer('5', [this.tilesetCity, this.tilesetJungle], 0, 0);
        this.camada6 = this.map.createLayer('6', [this.tilesetCity, this.tilesetJungle, this.tilesetBandeira], 0, 0);
