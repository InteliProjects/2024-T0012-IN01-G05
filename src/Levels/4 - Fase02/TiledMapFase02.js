...
export default class TiledMapFase02 {
    constructor(scene) {
        // Recebe a cena como parâmetro
        this.scene = scene;
        // Cria o mapa de tiles
        this.map = this.scene.make.tilemap({ key: 'mapFase02' });
        ...
        this.camada5 = this.map.createLayer('5', [this.tilesetCity, this.tilesetJungle], 0, 0);
       // this.camada6 = this.map.createLayer('6', [this.tilesetCity, this.tilesetJungle], 0, 0);
        this.camada7 = this.map.createLayer('7', [this.tilesetCity, this.tilesetJungle, this.tilesetBandeira], 0, 0);
