...
export default class TiledMapFase02F {
    constructor(scene) {
        // Recebe a cena como parâmetro
        this.scene = scene;
        // Cria o mapa de tiles
        this.map = this.scene.make.tilemap({ key: 'mapaF02' });

        // Carrega os tilesets para o mapafloresta
        ...
        this.camada1 = this.map.createLayer('1', [this.tilesetCity, this.tilesetJungle], 0, 0);
        ...
        this.camada5 = this.map.createLayer('5', [this.tilesetCity, this.tilesetJungle, this.tilesetBandeira], 0, 0);
       // this.camada6 = this.map.createLayer('6', [this.tilesetCity, this.tilesetJungle], 0, 0);
        ...
        this.camada8 = this.map.createLayer('8', [this.tilesetCity, this.tilesetJungle], 0, 0);
